...
## キーボードショートカットで起動させるには
Automatorでこのアプリを実行するアプリを作ります。

そのAutomatorアプリを起動するAutomatorワークーフローを作成し、サービスメニューのショートカットを登録します。

（私の環境では、ワークフロー内で直接Swiftアプリを実行するとセキュリティ制限に引っかかるのでこういう形にしています）

https://ryjkmr.com/mac_ocr_swift_app/
